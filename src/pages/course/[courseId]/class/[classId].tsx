...
const CoursePage: React.FC<CoursePageProps> = ({ courseId, classId }) => {
  ...
  return (
    <React.Fragment>
      <NextSeo title={activeClass?.className} />
                        ...
                        <ScrollArea.Viewport className="w-full h-full overflow-scroll">
                          {aulas?.map((aula) => (
                            <Lesson
                              ...
                              isActive={aula.classId === classId}
                              handleClick={() =>
                                push(
                                  `/course/${courseId}/class/${aula.classId}`
                                )
                              }
                            />
                          ))}
