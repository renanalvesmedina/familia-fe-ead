...
export function EditUser() {
  ...
  useEffect(() => {
    ...
    api.get(`/v1/User/details?UserId=${userId}`)
    .then(res => {
      setUser(res.data);
        ...
        <div className="w-full">
          ...
          <div className="flex flex-col p-4 mt-4 gap-4">
            <div className="flex justify-center mt-10">
              {/* FORM => */}
              <form className="w-full lg:max-w-2xl p-6 lg:p-0" onSubmit={handleEditUser}>
                ...
                <select onChange={handleGenderChange} value={userGender} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-brand-600 focus:ring-brand-600 focus:ring-1 focus:outline-none block w-full p-4 mb-4">
                ...
                <div className="flex gap-2">
                  <input type="radio" name="gender" value="Student" className="radio border-1" checked={profiles === "Student"} onChange={handleProfileChange} /> <span className="text-zinc-900 mr-4">Aluno</span>
                  <input type="radio" name="gender" value="Admin" className="radio border-1" checked={profiles === "Admin"} onChange={handleProfileChange} /> <span className="text-zinc-900">Administrador</span>
                </div>
