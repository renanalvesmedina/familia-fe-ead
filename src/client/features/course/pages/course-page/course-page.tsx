          ...
          <Container className="my-20 px-4 space-y-24">
            <div className="space-y-16 md:space-y-10">
              ...
              {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center justify-between border border-gray-200 dark:border-transparent bg-white shadow dark:shadow-none dark:bg-zinc-800 p-6 rounded-lg space-y-4 relative">
                    <div>
              ...
              <div className="space-y-4">
                {aulas?.map((aula) => (
                  <LessonCard
                    ...
                    handleClick={() =>
                      push(`/course/${courseId}/class/${aula.classId}`)
                    }
                  />
                ))}
              </div>
